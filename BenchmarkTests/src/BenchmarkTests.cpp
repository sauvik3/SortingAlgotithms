...
{
    template <typename T>
    std::vector<T> create_random_data(const std::size_t sz, const T range_from = std::numeric_limits<T>::min(),
...
namespace BenchmarkTests
{
    ...
    BENCHMARK(BM_Random_BubbleSort)->RangeMultiplier(2)->Range(1 << 7, 1 << 14)->Unit(benchmark::kMillisecond)->Complexity([](benchmark::IterationCount n)
    ...
    BENCHMARK(BM_Random_InsertionSort)->RangeMultiplier(2)->Range(1 << 7, 1 << 14)->Unit(benchmark::kMillisecond)->Complexity([](benchmark::IterationCount n)
                                                                                                                              { return static_cast<double>(n); });
    ...
    BENCHMARK(BM_Random_MergeSort)->RangeMultiplier(2)->Range(1 << 7, 1 << 14)->Unit(benchmark::kMillisecond)->Complexity([](benchmark::IterationCount n)
                                                                                                                          { return static_cast<double>(n); });
    ...
    BENCHMARK(BM_Random_QuickSort)->RangeMultiplier(2)->Range(1 << 7, 1 << 14)->Unit(benchmark::kMillisecond)->Complexity([](benchmark::IterationCount n)
                                                                                                                          { return static_cast<double>(n); });
    ...
    BENCHMARK(BM_Random_SelectionSort)->RangeMultiplier(2)->Range(1 << 7, 1 << 14)->Unit(benchmark::kMillisecond)->Complexity([](benchmark::IterationCount n)
                                                                                                                              { return static_cast<double>(n); });
}
